...
# Static files serving (works even behind Gunicorn when you open :8000 directly)
# Django 4.2+ prefers STORAGES; Django 6 uses it as the main configuration point.
STORAGES = {
    "staticfiles": {
